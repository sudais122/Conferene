...
import { LuBrain, LuUsers, LuLaptop } from "react-icons/lu";
          ...
          {conferenceAreas.map((area, index) => {
            ...
            return (
              <article
                key={area.title}
                className={`
                  group flex min-h-24 items-center gap-4 sm:min-h-28 sm:gap-5
                  border-[#cbdde3] bg-white px-5 py-5 sm:px-7
